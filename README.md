...
The .csv files comprise grid information for ten US states and two Canadian provinces. These files are generated by the code in location.ipynb. The data extracted from these files are utilized in creating Figure 4, Figure 5, and Table 1.
